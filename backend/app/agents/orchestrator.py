"""Agent Orchestrator â€” routes tasks to the right agent and manages lifecycle."""
...
class AgentOrchestrator:
    ...
    Coordinates multiple agents to handle a full monitoring workflow:
        ...
        MonitorAgent  â†’  AnomalyAgent  â†’  InvestigatorAgent  â†’  ReporterAgent
             â†“                â†“                   â†“                    â†“
    ...
    async def run_monitor_pipeline(
        ...
        # 1. MonitorAgent â€” fetch current metric value(s)
        ...
        # 2. AnalystAgent â€” detect anomaly
        ...
        # 3. ReporterAgent â€” synthesize executive briefing
